$(document).ready(function() {
    ...
    //
    // Lets work out the size of the canvas 
    //
    
    var mainWebGLViewHeight = mainviewHeight - (2 * mainviewPadding);
    var mainWebGLViewWidth = mainContainerWidth - (2 * mainviewPadding);
    $('#webglCanvas').css('height',mainWebGLViewHeight);
    $('#webglCanvas').css('width',mainWebGLViewWidth);
    ...
    var mainfooterHeight = mainContainerHeight - mainheadingHeight - mainmenuHeight - mainviewHeight + 15;
